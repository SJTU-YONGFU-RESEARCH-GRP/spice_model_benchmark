...
# 
# Prerequisite: (a) Verilog file (Eg: slow corner: slow_vdd1v0_dNW0v3_basicCells_backbias.v  )
#               (b) cds.lib file (for define library, Eg: gsclib045_backbias)
#
# Syntax: compile_gsclib045_lvt_functional.csh
#---------------------------------------------------------------------------------
#
set verilogFile = slow_vdd1v0_dNW0v3_basicCells_backbias.v
set libName     = gsclib045_backbias

...
; Generated on Jul 30 12:32:39 2010
;     with @(#)$CDS: techManager.exe version 6.1.3 05/19/2010 01:21 (cic612lnx) $
 ...
 ;( -----	---------- )
  ( "foundry"	nil
	...
	( diffAreaRatio      "Via1"
       ...
       antenna(
	( areaRatio          "Metal6"     500.0 )
       ) ;antenna
       antenna(
	( areaRatio          "Metal5"     500.0 )
       ) ;antenna
       antenna(
	( areaRatio          "Metal4"     500.0 )
       ) ;antenna
       antenna(
	( areaRatio          "Metal3"     500.0 )
       ) ;antenna
       antenna(
	( areaRatio          "Metal2"     500.0 )
       ) ;antenna
       antenna(
	( areaRatio          "Metal1"     500.0 )
       ) ;antenna

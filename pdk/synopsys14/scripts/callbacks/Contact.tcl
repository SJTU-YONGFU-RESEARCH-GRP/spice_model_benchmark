...
proc getCurrentParamValue_CONTACT {param_name} {
	return [is_digit_CONTACT [db::getParamValue $param_name -of [getCurrentInstance_CONTACT]]]
}
...
proc Contact14 {} { 
	set layer1             [is_digit_CONTACT [getCurrentParamValue_CONTACT "layer1"]]
	set layer2             [is_digit_CONTACT [getCurrentParamValue_CONTACT "layer2"]]
	set routeDir1          [is_digit_CONTACT [getCurrentParamValue_CONTACT "routeDir1"]]
	set routeDir2          [is_digit_CONTACT [getCurrentParamValue_CONTACT "routeDir2"]]
	set width              [is_digit_CONTACT [getCurrentParamValue_CONTACT "width"]]
	set height             [is_digit_CONTACT [getCurrentParamValue_CONTACT "height"]]
	set addLayers          [is_digit_CONTACT [getCurrentParamValue_CONTACT "addLayers"]]
	set ruleset            [is_digit_CONTACT [getCurrentParamValue_CONTACT "ruleset"]]
	set deviceContext      [is_digit_CONTACT [getCurrentParamValue_CONTACT "deviceContext"]]

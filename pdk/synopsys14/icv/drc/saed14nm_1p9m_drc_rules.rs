...

{
	...
	{
		@ "M1_3.S.1: Minimum M1_3 spacing must be 0.033";
		external1 ( m1_3 , distance < 0.033 ,extension = RADIAL, relational = POINT_TOUCH);
	}
...
//***********************************************   M2 RULES 
	...
	{
		@ "M2.S.1: Minimum M2 spacing must be 0.033";
		external1 ( m2 , distance < 0.033 ,extension = RADIAL, relational = POINT_TOUCH);
	}
...
//***********************************************   M2_3 RULES 
	...
	{
		@ "M2_3.S.1: Minimum M2_3 spacing must be 0.033";
		external1 ( m2_3 , distance < 0.033 ,extension = RADIAL, relational = POINT_TOUCH);
	}
...
//***********************************************   M3 RULES 
	...
	{
		@ "M3.S.1: Minimum M3 spacing must be 0.033";
		external1 ( m3 , distance < 0.033 ,extension = RADIAL, relational = POINT_TOUCH);
	}
...
/********************** M3_3 rules ******************/
	...
	{
		@ "M3_3.S.1: Minimum M3_3 spacing must be 0.033";
		external1 ( m3_3 , distance < 0.033 ,extension = RADIAL, relational = POINT_TOUCH);
	}

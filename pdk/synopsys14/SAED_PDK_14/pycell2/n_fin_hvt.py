...
Lfin = 0.15			# fin length or gate length
Tsi = 0.01			# fin width
...
#generate nplus 	
		...
		Rect(Layer('nwell'), Box(x1, y1, x2, y2)) 
...
#generate Thick_ox 	
		...
		Rect(Layer('metal7'), Box(xo1, yo1, xo2, yo2)) 
